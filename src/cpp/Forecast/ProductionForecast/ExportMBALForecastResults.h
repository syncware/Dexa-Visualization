                                         ...
                                         string &ModuleName)
{
    ...
    // isLastRow
    row = to_string(r.cGR) + columnDelimeter + to_string(r.cumGasProduced) + columnDelimeter + to_string(r.cumOilProduced) + columnDelimeter + to_string(r.cumWaterProduced) + columnDelimeter + to_string(r.deltaPPressure) + columnDelimeter + to_string(r.deltaPTubing) + columnDelimeter + to_string(r.dPChoke) + columnDelimeter + to_string(r.fBHP) + columnDelimeter + to_string(r.gasRate) + columnDelimeter + to_string(r.gLR) + columnDelimeter + to_string(r.gOR) + columnDelimeter + to_string(r.liquidRate) + columnDelimeter + to_string(r.manPress) + columnDelimeter + to_string(r.numberOfWells) + columnDelimeter + to_string(r.oilRate) + columnDelimeter + r.status + columnDelimeter + to_string(r.tankPressure) + columnDelimeter + r.time + columnDelimeter + r.uniqueId + columnDelimeter + to_string(r.waterCut) + columnDelimeter + to_string(r.waterRate) + columnDelimeter + lastrow;
