...
#ifndef CALCULATEDECKVARIABLES2_H
#define CALCULATEDECKVARIABLES2_H
#endif
...
public:
	...
	using pFUNC = double (CalculateDeckVariables2::*)(double);
...
CalculateDeckVariables2::CalculateDeckVariables2()
{
}
...
double CalculateDeckVariables2::Percentile(vector<ForecastResult> &onstreamWells, double& p) {
...
vector<ForecastResult> CalculateDeckVariables2::SortOnstreamWellsByProbabilityDistribution(vector<ForecastResult> &onstreamWells)
{
...
vector<ForecastResult> CalculateDeckVariables2::SortOnstreamWellsByMean(vector<ForecastResult> &onstreamWells)
{
...
vector<ForecastResult> CalculateDeckVariables2::SortOnstreamWells(vector<ForecastResult> &onstreamWells)
{
...
int CalculateDeckVariables2::isContainFluidFractionIndicator(vector<double> &uniqueFluidFractionIndicators, double& fluidFraction){
	int check = -1;
...
vector<double> CalculateDeckVariables2::GetUniqueFluidFractionIndicators(vector<ForecastResult> &onstreamWells){
...
int CalculateDeckVariables2::isContainText(vector<string>& texts, string& text){
	int check = -1;
...
bool CalculateDeckVariables2::GetIsWellFlowing(bool &isOilTerminated, bool &isGasTerminated, bool &isWaterterminated)
{
...
bool CalculateDeckVariables2::CheckWellFacility(vector<WellFacilityData> WellFacilityDataList, string ModuleName, string FacilityName)
{
	bool check = false;
	int i = 0;
...
tuple<bool, int> CalculateDeckVariables2::CheckWellFacilityAndGetIndex(vector<WellFacilityData> WellFacilityDataList, string ModuleName)
{
	bool check = false;
	int i = 0;
	int n = WellFacilityDataList.size();
...
void CalculateDeckVariables2::GetFacilityFlowRates(vector<Node> &updatesNodes)
{
...
void CalculateDeckVariables2::GetDownStreamNodesFlux(vector<Node> &updatesNodes, int &activeNodeIndex)
{
...
void CalculateDeckVariables2::AdjustWellsFlowRates(vector<Node> &updatesNodes,
												  vector<int> &daysList, int &scenario, vector<FacilityStruct> &FacilityTable,
												  string &forecastCase, vector<vector<Priotization>> &priotizationsFacilities,
												  vector<vector<vector<InputDeckStruct>>> &Faclities,
												  vector<Date>& dateTimes)
...
void CalculateDeckVariables2::GetDeckVariables(vector<vector<vector<InputDeckStruct>>> &Faclities,
											  vector<int> &daysList, int &scenario, vector<FacilityStruct> &FacilityTable,
...
void CalculateDeckVariables2::GetDeckVariables(vector<InputDeckStruct> &facility,
											  vector<int> &daysList, int &scenario, int &facilityCounter,
											  FacilityStruct &facilityStruct, int &dateIndex, int &numberOfFacilities,
											  vector<vector<vector<InputDeckStruct>>> &Faclities,
											  string &forecastCase, Priotization &priotizationFacility)
...
void CalculateDeckVariables2::GetDeckVariables2(vector<InputDeckStruct> &facility,
											   vector<int> &daysList, int &scenario, int &facilityCounter,
											   FacilityStruct &facilityStruct, int &dateIndex, int &numberOfFacilities,
											   vector<vector<vector<InputDeckStruct>>> &Faclities,
											   string &forecastCase, Priotization &priotizationFacility,
...
void CalculateDeckVariables2::GetOnstreamWells(int &facilityCounter, int &timeStepCounter, int &nWells,
											  FacilityStruct &facilityStruct, string& forecastCase, Priotization& priotizationFacility)
{
...
void CalculateDeckVariables2::GetOnstreamWells2(int &facilityCounter, int &timeStepCounter, int &nWells,
...
void CalculateDeckVariables2::GetCurrentFacilityData()
{
...
void CalculateDeckVariables2::optimize_constraint_no_prioritization(vector<ForecastResult> &onStreamWells,
	vector<double> &cutbacks2, Priotization &priotizationFacility)
{
...
void CalculateDeckVariables2::optimize_constraint_by_well(vector<ForecastResult> &onStreamWells,
														 vector<double> &cutbacks2, Priotization &priotizationFacility)
{
...
void CalculateDeckVariables2::optimize_by_stream_prioritization(vector<ForecastResult> &onStreamWells,
														 vector<double> &cutbacks2, Priotization &priotizationFacility)
{
...
void CalculateDeckVariables2::optimize_olderNode_children(vector<Node> &nodes, int &nodeIndex,
...
void CalculateDeckVariables2::SetCutRatesBackValues(int &facilityCounter, int &timeStepCounter, double &onStreamWellCutBack,
	int &scenario, InputDeckStruct &deck, int &actualWellIndex)
{
...
void CalculateDeckVariables2::SetCutRatesBackValues(int &facilityCounter, int &timeStepCounter,
												   int &scenario, InputDeckStruct &deck, int &actualWellIndex,
												   double &gasCutBack, double &liquidCutBack)
{
	bool isAfetrOptimization = true;
...
void CalculateDeckVariables2::GetActiveRate(int &scenario,
...
void CalculateDeckVariables2::GetVariables(int &scenario, InputDeckStruct &deck,
										  ForecastResult &forecastResult, ForecastResult &forecastResult_old,
										  double &externalCurrentCumProd, bool &isAfetrOptimization)
{
...
double CalculateDeckVariables2::fun(double ProductionDays)
{
	double rate = DCA.Get_DCA_Exponential2(initial_rate, rate_of_change, ProductionDays);
	return rate;
}

double CalculateDeckVariables2::fun2(double ProductionDays)
{
	double rate = DCA.Get_DCA_Exponential2(initial_rate, rate_of_change, ProductionDays);
	return rate;
}

double CalculateDeckVariables2::TraplRule(pFUNC fun, double lower, double upper, int subInterval)
{
	int i;
	double k;
...
void CalculateDeckVariables2::GetActiveCumProd(int &scenario, InputDeckStruct &deck, ForecastResult &forecastResult, ForecastResult &forecastResult_old)
{

	CalculateDeckVariables2 obj;
	string logger = "";
	double MM = 1000000.0;
	...
	if (deck.Hydrocarbon_Stream == oil)
	{
		...
		auto fp = bind(&CalculateDeckVariables2::fun2, obj, std::placeholders::_1);
...
void CalculateDeckVariables2::GetGasFractionalFlow(int &scenario, InputDeckStruct &deck, ForecastResult &forecastResult,
ForecastResult &forecastResult_old)
{
...
void CalculateDeckVariables2::GetWaterFractionalFlow(int &scenario, InputDeckStruct &deck, 
ForecastResult &forecastResult, ForecastResult &forecastResult_old)
{
	double cumprod = 0, plateauCumProd = 0;
	double cumprodNoPlateau = 0;
...
void CalculateDeckVariables2::GetRates(int &scenario, InputDeckStruct &deck, ForecastResult &forecastResult)
{
	double MM = 1000000.0;
	string logger = "";
...
void CalculateDeckVariables2::GetCumProds(int &scenario, InputDeckStruct &deck, ForecastResult &forecastResult, ForecastResult &forecastResult_old)
{
...
void CalculateDeckVariables2::WellAbandonmentConditions(int &scenario, InputDeckStruct &deck, ForecastResult &forecastResult, ForecastResult &forecastResult_old)
{
