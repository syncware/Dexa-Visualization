...
void Inputdeck::CalculateDeclineParameters(InputDeckStruct &extendedInputDeck)
{
	...
	if (extendedInputDeck.Hydrocarbon_Stream == oil)
	{
		...
		extendedInputDeck.PlateauUR_1P_1C = extendedInputDeck.Plateau_Oil_Gas * days365 * (extendedInputDeck.Init_Liquid_Gas_Rate_1P_1C / (1 - extendedInputDeck.Init_BSW_WGR)) / MM;
		...
		extendedInputDeck.PlateauUR_2P_2C = extendedInputDeck.Plateau_Oil_Gas * days365 * (extendedInputDeck.Init_Liquid_Gas_Rate_2P_2C / (1 - extendedInputDeck.Init_BSW_WGR)) / MM;
		...
		extendedInputDeck.PlateauUR_3P_3C = extendedInputDeck.Plateau_Oil_Gas * days365 * (extendedInputDeck.Init_Liquid_Gas_Rate_3P_3C / (1 - extendedInputDeck.Init_BSW_WGR)) / MM;
