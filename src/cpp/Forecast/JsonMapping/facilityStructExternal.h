...
void from_json(const json &j, FacilityStructExternal &fse)
{
  ...
  if (j.contains("Scheduled_Deferment1P"))
    j.at("Scheduled_Deferment1P").get_to(fse.Scheduled_Deferment1P);
  if (j.contains("Scheduled_Deferment2P"))
    j.at("Scheduled_Deferment2P").get_to(fse.Scheduled_Deferment2P);
  if (j.contains("Scheduled_Deferment3P"))
    j.at("Scheduled_Deferment3P").get_to(fse.Scheduled_Deferment3P);

  if (j.contains("Unscheduled_Deferment1P"))
    j.at("Unscheduled_Deferment1P").get_to(fse.Unscheduled_Deferment1P);
  if (j.contains("Unscheduled_Deferment2P"))
    j.at("Unscheduled_Deferment2P").get_to(fse.Unscheduled_Deferment2P);
  if (j.contains("Unscheduled_Deferment3P"))
    j.at("Unscheduled_Deferment3P").get_to(fse.Unscheduled_Deferment3P);

  if (j.contains("Thirdparty_Deferment1P"))
    j.at("Thirdparty_Deferment1P").get_to(fse.Thirdparty_Deferment1P);
  if (j.contains("Thirdparty_Deferment2P"))
    j.at("Thirdparty_Deferment2P").get_to(fse.Thirdparty_Deferment2P);
  if (j.contains("Thirdparty_Deferment3P"))
    j.at("Thirdparty_Deferment3P").get_to(fse.Thirdparty_Deferment3P);

  if (j.contains("Crudeoil_Lossess1P"))
    j.at("Crudeoil_Lossess1P").get_to(fse.Crudeoil_Lossess1P);
  if (j.contains("Crudeoil_Lossess2P"))
    j.at("Crudeoil_Lossess2P").get_to(fse.Crudeoil_Lossess2P);
  if (j.contains("Crudeoil_Lossess3P"))
    j.at("Crudeoil_Lossess3P").get_to(fse.Crudeoil_Lossess3P);
  ...
  if (j.contains("ProductionShareLow"))
    j.at("ProductionShareLow").get_to(equityPercentage1P);
  ...
  if (j.contains("ProductionShareHigh"))
    j.at("ProductionShareHigh").get_to(equityPercentage3P);
